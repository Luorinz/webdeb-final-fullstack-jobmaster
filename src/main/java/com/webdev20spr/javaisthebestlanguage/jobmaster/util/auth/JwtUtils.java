package com.webdev20spr.javaisthebestlanguage.jobmaster.util.auth;
...
//    private Long refresh_token_expiration;
     ...
     * should contain username, role
     * @param token
     * @return
     */
    public JwtUserDetail getUserFromToken(String token) {
        JwtUserDetail userDetail;
        try {
            ...
            userDetail = new JwtUserDetail(username, role);
        } catch (Exception e) {
            userDetail = null;
        }
        return userDetail;
    ...
    public String generateAccessToken(JwtUserDetail userDetail) {
...
//    }
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        JwtUserDetail userDetail = (JwtUserDetail) userDetails;
...
//    public String generateRefreshToken(JwtUserDetail userDetail) {
//        Map<String, Object> claims = generateClaims(userDetail);
//        // 只授于更新 token 的权限
...
//    }
    ...
    private Map<String, Object> generateClaims(JwtUserDetail userDetail) {
